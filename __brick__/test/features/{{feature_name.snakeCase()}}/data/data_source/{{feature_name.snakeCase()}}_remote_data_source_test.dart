...
import '../../../../../lib/core/api/base_http_client.dart';
...
import '../../../../../lib/features/{{feature_name.snakeCase()}}/data/data_source/{{feature_name.snakeCase()}}_remote_data_source_impl.dart';
import '../../../../../lib/features/{{feature_name.snakeCase()}}/domain/entity/{{feature_name.snakeCase()}}_entity.dart';

import 'package:user_management/main.mapper.g.dart';
import 'package:user_management/main.reflectable.dart';
import '../../../../../lib/core/json_mapper_controller.dart';

@GenerateNiceMocks([MockSpec<BaseHttpClient>()])
void main() {
  var responseFromServer =
  File("${Directory.current.path}/test/env/get_all_{{feature_name.snakeCase()}}.json")
      .readAsStringSync();
  ...
  test("should return List<{{feature_name.pascalCase()}}> when success", () async {
    ...
    expect(response[0], isA<{{feature_name.pascalCase()}}Entity>());
  });
